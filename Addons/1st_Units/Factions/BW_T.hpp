...
// Crews
	...
	class CATD_BW_T_Soldier_Crew_Base: B_soldier_base_F
	{
		author = "1st CATD";
		scope = 2;
		scopeCurator = 0;
	...
	class CATD_BW_T_Soldier_Crew_Tank_Commander: CATD_BW_T_Soldier_Crew_Base
	{
		displayName = "Tank Commander";
		icon = "iconManLeader";
	};
	class CATD_BW_T_Soldier_Crew_Tank_Gunner: CATD_BW_T_Soldier_Crew_Base
	{
		displayName = "Tank Gunner";
		icon = "iconMan";
	};
	class CATD_BW_T_Soldier_Crew_Tank_Loader: CATD_BW_T_Soldier_Crew_Base
	{
		displayName = "Tank Loader";
		icon = "iconMan";
	};
	class CATD_BW_T_Soldier_Crew_Tank_Driver: CATD_BW_T_Soldier_Crew_Base
	{
		displayName = "Tank Driver";
		icon = "iconMan";
		engineer = true;
	};
	class CATD_BW_T_Soldier_Crew_Heli_Pilot: CATD_BW_T_Soldier_Crew_Base
	{
		displayName = "Helicopter Pilot";
		icon = "iconMan";
	};
	class CATD_BW_T_Soldier_Crew_Heli_Crew: CATD_BW_T_Soldier_Crew_Base
	{
		displayName = "Helicopter Crew";
		icon = "iconMan";
	};
	class CATD_BW_T_Soldier_Crew_Jet_Pilot: CATD_BW_T_Soldier_Crew_Base
	{
		displayName = "Jet Pilot";
		icon = "iconMan";
	};
	class CATD_BW_T_Soldier_Crew_Jet_WSO: CATD_BW_T_Soldier_Crew_Base
	{
...
// Special Forces
	...
	class CATD_BW_T_Soldier_Special_Base: B_soldier_base_F
	{
		author = "1st CATD";
		scope = 2;
		scopeCurator = 0;
...
// Basic Combat Training
	...
	class CATD_BW_T_Soldier_Ausbildung_Base: B_soldier_base_F
	{
		author = "1st CATD";
		scope = 2;
		scopeCurator = 0;
