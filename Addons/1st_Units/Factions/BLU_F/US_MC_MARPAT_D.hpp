...
// Support
    ...
    class CATD_US_MC_MARPAT_D_Soldier_Surgeon: CATD_US_MC_MARPAT_D_Soldier_Base
    {
        displayName = "Surgeon";
        icon = "iconManMedic";
        attendant = true;
...
// Crews
    ...
    class CATD_US_MC_MARPAT_D_Crew_Tank_Commander: CATD_US_MC_MARPAT_D_Crew_Base
    {
        displayName = "Tank Commander";
        icon = "iconManLeader";
    };
    class CATD_US_MC_MARPAT_D_Crew_Tank_Gunner: CATD_US_MC_MARPAT_D_Crew_Base
    {
        displayName = "Tank Gunner";
        icon = "iconMan";
    };
    class CATD_US_MC_MARPAT_D_Crew_Tank_Loader: CATD_US_MC_MARPAT_D_Crew_Base
    {
        displayName = "Tank Loader";
        icon = "iconMan";
    };
    class CATD_US_MC_MARPAT_D_Crew_Tank_Driver: CATD_US_MC_MARPAT_D_Crew_Base
    {
        displayName = "Tank Driver";
        icon = "iconMan";
        engineer = true;
    };
    class CATD_US_MC_MARPAT_D_Crew_Heli_Pilot: CATD_US_MC_MARPAT_D_Crew_Base
    {
        displayName = "Helicopter Pilot";
        icon = "iconMan";
    };
    class CATD_US_MC_MARPAT_D_Crew_Heli_Crew: CATD_US_MC_MARPAT_D_Crew_Base
    {
        displayName = "Helicopter Crew";
        icon = "iconMan";
    };
    class CATD_US_MC_MARPAT_D_Crew_Jet_Pilot: CATD_US_MC_MARPAT_D_Crew_Base
    {
        displayName = "Jet Pilot";
        icon = "iconMan";
    };
    class CATD_US_MC_MARPAT_D_Crew_Jet_WSO: CATD_US_MC_MARPAT_D_Crew_Base
    {
