if (_camo == "BW_F") then {
    ["PBW_Uniform3_fleck", "pbw_splitter_schtz", "BWA3_PatrolPack_Fleck", "PBW_Helm1_fleck_HBO"] call CATD_fnc_Outfit;
    ...
    ["launch_B_Titan_short_F"] call CATD_fnc_addWeapon;
...
if (_camo == "BW_T") then {
    ["PBW_Uniform3_tropen", "pbw_splitter_schtz", "BWA3_PatrolPack_Tropen", "PBW_Helm1_tropen_HBO"] call CATD_fnc_Outfit;
    ["hlc_rifle_G36A1"] call CATD_fnc_addWeapon;
    ["vest", "BWA3_30Rnd_556x45_G36", 6] call CATD_fnc_addItemTo;
    ["vest", "BWA3_30Rnd_556x45_G36_Tracer", 4] call CATD_fnc_addItemTo;
    ["BWA3_P8"] call CATD_fnc_addWeapon;
...
if (_camo == "US_A_OCP") then {
    ["rhs_uniform_cu_ocp", "rhsusf_iotv_ocp_Rifleman", "rhsusf_assault_eagleaiii_ocp_CATD", "rhsusf_ach_helmet_headset_ess_ocp"] call CATD_fnc_Outfit;
    ...
    ["rhs_weap_fgm148"] call CATD_fnc_addWeapon;
    ["backpack", "rhs_fgm148_magazine_AT", 2] call CATD_fnc_addItemTo;

    _unit linkItem "tf_anprc152";
    ["uniform", "ACE_Flashlight_MX991"] call CATD_fnc_addItemTo;
};
if (_camo == "US_A_UCP") then {
    ["rhs_uniform_cu_ucp", "rhsusf_iotv_ucp_Rifleman", "rhsusf_assault_eagleaiii_ucp_CATD", "rhsusf_ach_helmet_headset_ess_ucp"] call CATD_fnc_Outfit;
    ["rhs_weap_m16a4_carryhandle", "rhsusf_acc_ACOG"] call CATD_fnc_addWeapon;
    ["vest", "30Rnd_556x45_Stanag", 6] call CATD_fnc_addItemTo;
    ["vest", "30Rnd_556x45_Stanag_Tracer_red", 4] call CATD_fnc_addItemTo;
    ["rhsusf_weap_m9"] call CATD_fnc_addWeapon;
...
if (_camo == "US_MC_MARPAT_W") then {
    ["rhs_uniform_FROG01_wd", "rhsusf_spc_rifleman", "rhsusf_assault_eagleaiii_coy_CATD", "rhsusf_lwh_helmet_marpatwd_headset"] call CATD_fnc_Outfit;
    ["rhs_weap_m16a4_carryhandle", "rhsusf_acc_ACOG"] call CATD_fnc_addWeapon;
    ["vest", "30Rnd_556x45_Stanag", 6] call CATD_fnc_addItemTo;
    ["vest", "30Rnd_556x45_Stanag_Tracer_red", 4] call CATD_fnc_addItemTo;
    ["rhsusf_weap_m9"] call CATD_fnc_addWeapon;
...
if (_camo == "US_MC_MARPAT_D") then {
    ["rhs_uniform_FROG01_d", "rhsusf_spc_rifleman", "rhsusf_assault_eagleaiii_coy_CATD", "rhsusf_lwh_helmet_marpatd_headset"] call CATD_fnc_Outfit;
    ["rhs_weap_m16a4_carryhandle", "rhsusf_acc_ACOG"] call CATD_fnc_addWeapon;
    ["vest", "30Rnd_556x45_Stanag", 6] call CATD_fnc_addItemTo;
    ["vest", "30Rnd_556x45_Stanag_Tracer_red", 4] call CATD_fnc_addItemTo;
    ["rhsusf_weap_m9"] call CATD_fnc_addWeapon;
...
if (_camo == "BAF_BA_MTP") then {
    ["UK3CB_BAF_U_CombatUniform_MTP", "UK3CB_BAF_V_Osprey_Rifleman_E", "UK3CB_BAF_B_Carryall_MTP", "UK3CB_BAF_H_Mk7_Camo_E"] call CATD_fnc_Outfit;
...
if (_camo == "PMC") then {
    ["U_BG_Guerilla2_3", "V_PlateCarrier1_blk", "B_Carryall_cbr", "H_HelmetB_black"] call CATD_fnc_Outfit;
...
if (_camo == "RU_EMR_S") then {
    ["rhs_uniform_emr_patchless", "rhs_6b23_digi_6sh92", "rhs_rpg_empty", "rhs_6b27m_green_ess"] call CATD_fnc_Outfit;
    ...
    ["rhs_weap_rpg7"] call CATD_fnc_addWeapon;
    ["backpack", "rhs_rpg7_PG7VR_mag", 2] call CATD_fnc_addItemTo;
    ["backpack", "rhs_rpg7_PG7VL_mag"] call CATD_fnc_addItemTo;

    _unit linkItem "tf_fadak";
    ["uniform", "ACE_Flashlight_KSF1"] call CATD_fnc_addItemTo;
};
if (_camo == "RU_EMR_W") then {
    ["rhs_uniform_emr_des_patchless", "rhs_6b23_digi_6sh92", "rhs_rpg_empty", "rhs_6b27m_green_ess"] call CATD_fnc_Outfit;
    ["rhs_weap_ak74m_dtk", nil] call CATD_fnc_addWeapon;
    ["vest", "rhs_30Rnd_545x39_7N10_AK", 6] call CATD_fnc_addItemTo;
    ["vest", "rhs_30Rnd_545x39_AK_green", 4] call CATD_fnc_addItemTo;
    ["hgun_Rook40_F"] call CATD_fnc_addWeapon;
