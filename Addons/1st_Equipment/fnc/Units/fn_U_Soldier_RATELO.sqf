if (_camo == "BW_F") then {
    ["BWA3_Uniform2_Fleck", "BWA3_Vest_Rifleman1_Fleck", "tf_rt1523g_big_bwmod", "BWA3_MICH_Fleck"] call CATD_fnc_Outfit;
...
if (_camo == "BW_T") then {
    ["BWA3_Uniform2_Tropen", "BWA3_Vest_Rifleman1_Tropen", "tf_rt1523g_big_bwmod_tropen", "BWA3_MICH_Tropen"] call CATD_fnc_Outfit;
    ["hlc_rifle_G36A1"] call CATD_fnc_addWeapon;
    ["vest", "BWA3_30Rnd_556x45_G36", 6] call CATD_fnc_addItemTo;
    ["vest", "BWA3_30Rnd_556x45_G36_Tracer", 4] call CATD_fnc_addItemTo;
    ["BWA3_P8"] call CATD_fnc_addWeapon;
...
if (_camo == "US_A_OCP") then {
    ["rhs_uniform_cu_ocp", "rhsusf_iotv_ocp_Squadleader", "tf_rt1523g_big_rhs", "rhsusf_ach_helmet_headset_ocp"] call CATD_fnc_Outfit;
...
if (_camo == "US_A_UCP") then {
    ["rhs_uniform_cu_ucp", "rhsusf_iotv_ucp_Squadleader", "tf_rt1523g_green", "rhsusf_ach_helmet_headset_ucp"] call CATD_fnc_Outfit;
    ["rhs_weap_m4_carryhandle", "rhsusf_acc_ACOG"] call CATD_fnc_addWeapon;
    ["vest", "30Rnd_556x45_Stanag", 6] call CATD_fnc_addItemTo;
    ["vest", "30Rnd_556x45_Stanag_Tracer_red", 4] call CATD_fnc_addItemTo;
    ["rhsusf_weap_m9"] call CATD_fnc_addWeapon;
...
if (_camo == "US_MC_MARPAT_W") then {
    ["rhs_uniform_FROG01_wd", "rhsusf_spc_squadleader", "tf_rt1523g_sage", "rhsusf_mich_helmet_marpatwd_headset"] call CATD_fnc_Outfit;
...
if (_camo == "US_MC_MARPAT_D") then {
    ["rhs_uniform_FROG01_d", "rhsusf_spc_squadleader", "tf_rt1523g_sage", "rhsusf_mich_helmet_marpatd_headset"] call CATD_fnc_Outfit;
    ["rhs_weap_m16a4_carryhandle", "rhsusf_acc_ACOG"] call CATD_fnc_addWeapon;
    ["vest", "30Rnd_556x45_Stanag", 6] call CATD_fnc_addItemTo;
    ["vest", "30Rnd_556x45_Stanag_Tracer_red", 4] call CATD_fnc_addItemTo;
    ["rhsusf_weap_m9"] call CATD_fnc_addWeapon;
...
if (_camo == "BAF_BA_MTP") then {
    ["UK3CB_BAF_U_CombatUniform_MTP_ShortSleeve", "UK3CB_BAF_V_Osprey_Rifleman_C", "UK3CB_BAF_B_Bergen_MTP_Radio_L_A", "UK3CB_BAF_H_Mk7_Scrim_ESS_C"] call CATD_fnc_Outfit;
...
if (_camo == "PMC") then {
    ["U_BG_Guerilla2_1", "V_PlateCarrierL_CTRG", "tf_anprc155_coyote", "H_HelmetB_snakeskin"] call CATD_fnc_Outfit;
    ["arifle_SPAR_01_blk_F", "optic_Hamr"] call CATD_fnc_addWeapon;
    ["vest", "30Rnd_556x45_Stanag", 6] call CATD_fnc_addItemTo;
    ["vest", "30Rnd_556x45_Stanag_Tracer_red", 4] call CATD_fnc_addItemTo;
...
if (_camo == "RU_EMR_S") then {
    ["rhs_uniform_emr_patchless", "rhs_6b23_digi_6sh92_headset", "tf_bussole", "rhs_6b27m_digi"] call CATD_fnc_Outfit;
...
if (_camo == "RU_EMR_W") then {
    ["rhs_uniform_emr_des_patchless", "rhs_6b23_digi_6sh92_headset", "tf_bussole", "rhs_6b27m_digi"] call CATD_fnc_Outfit;
    ["rhs_weap_ak74m_dtk", nil] call CATD_fnc_addWeapon;
    ["vest", "rhs_30Rnd_545x39_7N10_AK", 6] call CATD_fnc_addItemTo;
    ["vest", "rhs_30Rnd_545x39_AK_green", 4] call CATD_fnc_addItemTo;
    ["hgun_Rook40_F"] call CATD_fnc_addWeapon;
