if (_camo == "BW_F") then {
    ["PBW_Uniform4_fleck", "pbw_splitter_sani", "BWA3_Kitbag_Fleck_Medic", "PBW_Helm1_fleck_H"] call CATD_fnc_Outfit;
...
if (_camo == "BW_T") then {
    ["PBW_Uniform4_tropen", "pbw_splitter_sani", "BWA3_Kitbag_Tropen_Medic", "PBW_Helm1_tropen_H"] call CATD_fnc_Outfit;
    ["hlc_rifle_G36A1"] call CATD_fnc_addWeapon;
    ["vest", "BWA3_30Rnd_556x45_G36", 6] call CATD_fnc_addItemTo;
    ["vest", "BWA3_30Rnd_556x45_G36_Tracer", 4] call CATD_fnc_addItemTo;
    ["BWA3_P8"] call CATD_fnc_addWeapon;
...
if (_camo == "BAF_BA_MTP") then {
    ["UK3CB_BAF_U_CombatUniform_MTP", "UK3CB_BAF_V_Osprey_Medic_B", "UK3CB_BAF_B_Bergen_MTP_Medic_H_B", "UK3CB_BAF_H_Mk7_Camo_A"] call CATD_fnc_Outfit;
...
if (_camo == "PMC") then {
    ["U_BG_Guerilla2_3", "V_PlateCarrier1_blk", "B_TacticalPack_blk", "H_HelmetB"] call CATD_fnc_Outfit;
