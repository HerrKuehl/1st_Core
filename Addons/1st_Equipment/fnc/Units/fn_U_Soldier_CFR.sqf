if (_camo == "BW_F") then {
    ["BWA3_Uniform2_Fleck", "BWA3_Vest_Medic_Fleck", "BWA3_Kitbag_Fleck_Medic", "BWA3_M92_Fleck"] call CATD_fnc_Outfit;
...
if (_camo == "BW_T") then {
    ["BWA3_Uniform2_Tropen", "BWA3_Vest_Medic_Tropen", "BWA3_Kitbag_Tropen_Medic", "BWA3_M92_Tropen"] call CATD_fnc_Outfit;
    ["hlc_rifle_G36A1"] call CATD_fnc_addWeapon;
    ["vest", "BWA3_30Rnd_556x45_G36", 6] call CATD_fnc_addItemTo;
    ["vest", "BWA3_30Rnd_556x45_G36_Tracer", 4] call CATD_fnc_addItemTo;
    ["BWA3_P8"] call CATD_fnc_addWeapon;
...
if (_camo == "US_MC_MARPAT_D") then {
    ["rhs_uniform_FROG01_d", "rhsusf_spc_corpsman", "rhsusf_assault_eagleaiii_coy_CATD", "rhsusf_lwh_helmet_marpatd"] call CATD_fnc_Outfit;
    ["rhs_weap_m16a4_carryhandle", "rhsusf_acc_ACOG"] call CATD_fnc_addWeapon;
    ["vest", "30Rnd_556x45_Stanag", 6] call CATD_fnc_addItemTo;
    ["vest", "30Rnd_556x45_Stanag_Tracer_red", 4] call CATD_fnc_addItemTo;
    ["rhsusf_weap_m9"] call CATD_fnc_addWeapon;
...
if (_camo == "BAF_BA_MTP") then {
    ["UK3CB_BAF_U_CombatUniform_MTP_ShortSleeve", "UK3CB_BAF_V_Osprey_Medic_D", "UK3CB_BAF_B_Bergen_MTP_Medic_L_A", "UK3CB_BAF_H_Mk7_Camo_D"] call CATD_fnc_Outfit;
...
if (_camo == "PMC") then {
    ["U_BG_Guerilla2_2", "V_PlateCarrier1_blk", "B_TacticalPack_blk", "H_HelmetSpecB_blk"] call CATD_fnc_Outfit;
...
if (_camo == "RU_EMR_S") then {
    ["rhs_uniform_emr_patchless", "rhs_6b23_digi_medic", "rhs_assault_umbts", "rhs_6b27m_digi"] call CATD_fnc_Outfit;
...
if (_camo == "RU_EMR_W") then {
    ["rhs_uniform_emr_des_patchless", "rhs_6b23_digi_medic", "rhs_assault_umbts", "rhs_6b27m_digi"] call CATD_fnc_Outfit;
    ["rhs_weap_ak74m_dtk", nil] call CATD_fnc_addWeapon;
    ["vest", "rhs_30Rnd_545x39_7N10_AK", 6] call CATD_fnc_addItemTo;
    ["vest", "rhs_30Rnd_545x39_AK_green", 4] call CATD_fnc_addItemTo;
    ["hgun_Rook40_F"] call CATD_fnc_addWeapon;
