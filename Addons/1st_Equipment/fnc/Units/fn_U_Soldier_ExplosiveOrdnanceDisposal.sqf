...
if (_camo == "US_MC_MARPAT_W") then {
    ["rhs_uniform_FROG01_wd", "rhsusf_spc_rifleman", "rhsusf_assault_eagleaiii_coy_CATD", "rhsusf_lwh_helmet_marpatwd_ess"] call CATD_fnc_Outfit;
...
if (_camo == "BAF_BA_MTP") then {
    ["UK3CB_BAF_U_CombatUniform_MTP", "UK3CB_BAF_V_Osprey_Rifleman_F", "UK3CB_BAF_B_Bergen_MTP_Sapper_H_A", "UK3CB_BAF_H_Mk7_Net_ESS_C"] call CATD_fnc_Outfit;
...
if (_camo == "PMC") then {
    ["U_BG_Guerrilla_6_1", "V_PlateCarrierSpec_blk", "B_Carryall_oli", "H_HelmetSpecB_sand"] call CATD_fnc_Outfit;
...
["backpack", "MineDetector"] call CATD_fnc_addItemTo;
["backpack", "Revo_mD_battery", 2] call CATD_fnc_addItemTo;
["backpack", "Revo_mD_flag", 6] call CATD_fnc_addItemTo;
...
["backpack", "DemoCharge_Remote_Mag", 2] call CATD_fnc_addItemTo;
