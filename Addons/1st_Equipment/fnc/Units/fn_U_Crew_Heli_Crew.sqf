if (_camo == "BW_F") then {
    ["BWA3_Uniform_Helipilot", "V_TacVest_oli", nil, "H_PilotHelmetHeli_B", "G_Bandanna_oli"] call CATD_fnc_Outfit;
...
if (_camo == "US_A_OCP") then {
    ["U_B_HeliPilotCoveralls", "V_TacVest_oli", nil, "rhsusf_hgu56p_mask"] call CATD_fnc_Outfit;
...
if (_camo == "BAF_BA_MTP") then {
    ["UK3CB_BAF_U_HeliPilotCoveralls_Army", "UK3CB_BAF_V_Pilot_A", nil, "UK3CB_BAF_H_PilotHelmetHeli_A", "G_Bandanna_oli"] call CATD_fnc_Outfit;
...
if (_camo == "PMC") then {
    ["U_BG_Guerilla2_2", "V_Rangemaster_belt", nil, "H_PilotHelmetHeli_I", "G_Bandanna_beast"] call CATD_fnc_Outfit;
...
if (_camo == "RU_EMR_S") then {
    ["rhs_uniform_df15", "rhs_vydra_3m", nil, "rhs_zsh7a_mike"] call CATD_fnc_Outfit;
...
if (_camo == "RU_EMR_W") then {
    ["rhs_uniform_df15_tan", "rhs_vydra_3m", nil, "rhs_zsh7a_mike_green"] call CATD_fnc_Outfit;
    ["hgun_Rook40_F"] call CATD_fnc_addWeapon;
    ["vest", "16Rnd_9x21_Mag", 3] call CATD_fnc_addItemTo;
