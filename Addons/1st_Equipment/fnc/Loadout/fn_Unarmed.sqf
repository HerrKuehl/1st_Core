...
if (_faction == "CATD_Faction_B_01") then {
    if ((_unitclass find "crew_tank") >= 0) then {
        ["PBW_Uniform1_fleck", nil, nil, "BWA3_Beret_Pz"] call CATD_fnc_Outfit;
    };
    if ((_unitclass find "crew_heli") >= 0) then {
        ["PBW_Uniform1_fleck", nil, nil, "BWA3_Beret_HFlieger"] call CATD_fnc_Outfit;
    };
    ...
    if (((_unitclass find "crew_heli") == -1) && ((_unitclass find "crew_tank") == -1) && ((_unitclass find "crew_jet") == -1)) then {
        ["PBW_Uniform1_fleck", nil, nil, "BWA3_Beret_PzGren"] call CATD_fnc_Outfit;
    };
};
// BW Tropen
if (_faction == "CATD_Faction_B_02") then {
    if ((_unitclass find "crew_tank") >= 0) then {
        ["PBW_Uniform1_tropen", nil, nil, "BWA3_Beret_Pz"] call CATD_fnc_Outfit;
    };
    if ((_unitclass find "crew_heli") >= 0) then {
        ["PBW_Uniform1_tropen", nil, nil, "BWA3_Beret_HFlieger"] call CATD_fnc_Outfit;
    };
    if ((_unitclass find "crew_jet") >= 0) then {
        ["PBW_Uniform1_tropen", nil, nil, "BWA3_Beret_HFlieger"] call CATD_fnc_Outfit;
    };
    if (((_unitclass find "crew_heli") == -1) && ((_unitclass find "crew_tank") == -1) && ((_unitclass find "crew_jet") == -1)) then {
        ["PBW_Uniform1_tropen", nil, nil, "BWA3_Beret_PzGren"] call CATD_fnc_Outfit;
    };
};
// US Army OCP
